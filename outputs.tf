...
output "vm_resource_group_names" {
  description = "The name of the vms resource group"
  value = concat(
    azurerm_virtual_machine.vm-windows.*.resource_group_name,
    azurerm_virtual_machine.vm-linux.*.resource_group_name,
  )
}
